 ...
 * @license		http://www.itfosters.com/user_guide/license.html
 * @link		http://www.itfosters.com
 * @since		Version 1.0
 * @filesource
 */
 ...
 * @author		ExpressionEngine Dev Team
 * @category	Loader
 * @link		http://www.itfosters.com/user_guide/libraries/javascript.html
 */
 
class ITF_Jquery extends ITF_Javascript {
	...
	{	
		...
		$controller = (strpos('://', $controller) === FALSE) ? $controller : $this->ITF->config->site_url($controller);
		
		// ajaxStart and ajaxStop are better choices here... but this is a stop gap
		if ($this->ITF->config->item('javascript_ajax_img') == '')
		{
			$loading_notifier = "Loading...";
		}
		else
		{
			$loading_notifier = '<img src=\'' . $this->ITF->config->slash_item('base_url') . $this->ITF->config->item('javascript_ajax_img') . '\' alt=\'Loading\' />';
		}
	...
	function _compile($view_var = 'script_foot', $script_tags = TRUE)
	{
		...
		$this->ITF->load->vars(array('library_src' => $external_scripts));
		...
		$this->ITF->load->vars(array($view_var => $output));
