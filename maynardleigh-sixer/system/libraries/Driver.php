...
/**
 * ITFosters Driver Library Class
 *
...
class ITF_Driver_Library {
	...
	function __get($child)
	{
		...
		// Remove the ITF_ prefix and lowercase
		$lib_name = ucfirst(strtolower(str_replace('ITF_', '', $this->lib_name)));
		$driver_name = strtolower(str_replace('ITF_', '', $child_class));
...
// END ITF_Driver_Library CLASS


/**
 * ITFosters Driver Class
 *
