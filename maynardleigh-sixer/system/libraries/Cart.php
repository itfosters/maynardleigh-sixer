 ...
 * @author		ExpressionEngine Dev Team
 * @link		http://itfosters.com/user_guide/libraries/cart.html
 */
class ITF_Cart {
	...
	public function __construct($params = array())
	{
		...
		$this->ITF->load->library('session', $config);

		// Grab the shopping cart array from the session table, if it exists
		if ($this->ITF->session->userdata('cart_contents') !== FALSE)
		{
			$this->_cart_contents = $this->ITF->session->userdata('cart_contents');
		}
		else
		{
	...
	function _save_cart()
	{
		...
		{
			$this->ITF->session->unset_userdata('cart_contents');
		...
		$this->ITF->session->set_userdata(array('cart_contents' => $this->_cart_contents));
