...
<head>
   ...
   <script>var FRONTURL ='<?php echo base_url(); ?>';</script>
    ...
    <link href="<?php echo ASSESTS_ULR."admin/css/timepicker.css"; ?>" rel="stylesheet">
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="<?php echo site_url("welcome/myinfo"); ?>"><i class="fa fa-user-plus"></i> My Profile</a></li>
                            <li class="divider"></li>
        ...
        <nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <?php  //echo '<pre>';print_r($loginuserinfo["LOGEDDATA"]->user_type);die; 

                            if($loginuserinfo["LOGEDDATA"]->user_type=='CM'){
                    ?>
