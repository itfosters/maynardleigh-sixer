...
<html lang="en"><head>
    ...
    <link href="<?php echo base_url('assests/admin/css');?>/bootstrap.css" rel="stylesheet">
    ...
    <link href="<?php echo base_url('assests/admin/css');?>/font-awesome.min.css" rel="stylesheet">
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="#itf"><i class="fa fa-users"></i>User Management <span class="fa icondown arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="<?php echo site_url("admin/user/employee"); ?>"><i class="fa fa-user"></i>Employee</a></li> 
                    ...
                    <li><a href="<?php echo site_url('admin/product');?>"><i class="fa fa-users"></i>Product</a></li>

                     
                    <!-- <li><a href="<?php echo site_url("admin/salary"); ?>"><i class="fa fa-tag"></i>Salary</a></li>                                                                                  
                    <li><a href="<?php echo site_url("admin/attendence"); ?>"><i class="fa fa-tag"></i>Attendence</a></li>        -->                                                                           
                    <li><a href="#itf"><i class="fa fa fa-cogs"></i>Setting <span class="fa icondown arrow"></span></a>
                        <ul class="nav nav-second-level">
                             <li><a href="<?php echo site_url("admin/location"); ?>"><i class="fa fa-tag"></i>Location</a></li> 
                             <li><a href="<?php echo site_url("admin/job_category"); ?>"><i class="fa fa-tag"></i>Job Category</a></li> 
                             <li><a href="<?php echo site_url("admin/job_type"); ?>"><i class="fa fa-tag"></i>Job Type</a></li> 
