...
?>
        ...
        <div id="accordion" role="tablist" aria-multiselectable="true">    
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-4 mb10">
                        <b>Location : </b>
                        <?php echo (isset($frmdata['detail']->alocation)and !empty($frmdata['detail']->street))? $frmdata['detail']->alocation: 'N/A'?>
                    </div>
                    <div class="col-md-4 mb10">
                        <b>City: </b>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-4 mb10">
                        ...
                        <?php 
                        if(isset ($frmdata['detail']->cancellation_clouse) and !empty($frmdata['detail']->cancellation_clouse)){
                            ?>
                        <ol>
		<?php
		...
		?>
                        ...
                        //echo (isset ($frmdata['detail']->cancellation_clouse) and !empty($frmdata['detail']->cancellation_clouse))? $cancellationClouseArray[2] : 'N/A'
                            ?>
                    </div>
                    <div class="col-md-4 mb10">
                    ...
                    <div class="col-md-4 mb10">
                     ...
                     <div class="col-md-4 mb10">
                        <b>Payment Terms:</b>
                        <?php echo (isset ($frmdata['detail']->termsconditions) and !empty ($frmdata['detail']->termsconditions))? $frmdata['detail']->termsconditions:'N/A'?>
                    </div>
                     <div class="col-md-4 mb10">
                        <b>Service Tax: </b>
                        <?php echo (isset ($frmdata['detail']->tax) and !empty ($frmdata['detail']->tax))? $frmdata['detail']->tax:'N/A'?>
                    </div>
                 </div>
                </div>
                 <div class="greyborder">
                 <div class="panel-body">
                     <fieldset>
                        ...
                        <b>Booking Charges:</b>
                        <?php echo (isset ($frmdata['detail']->transport_tax) and !empty ($frmdata['detail']->transport_tax))? $frmdata['detail']->transport_tax:'N/A'?>
                        <!-- end section --> 
                        <!-- end frm-row section -->
                        <!-- end frm-row section -->
                        <!-- end section -->
          ...
          <?php 
					 ...
					 foreach($frmdata['diagonoesdetail'] as $k=>$diagonoses){ //echo "<pre>"; print_r($diagonoses->id);die;?>
                        ...
                        <div class="col-md-4 mb10">
                           <b>Product:</b>
                           <?php echo $diagonoses->product.(!empty($diagonoses->name)?" / ".$diagonoses->name:'');?>
                        </div>
                 ...
                 <?php 
				   ...
				   foreach($frmdata['getdesigndetail'] as $k=>$design){?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4 mb10">
                            <b>Product: </b>
                            <?php echo $design->product.(!empty($design->name)?" / ".$design->name:'');?> 
                        </div>
                        <div class="col-md-4 mb10">
                            <b>Weight: </b>
            ...
            <div class="panel panel-primary">
                ...
                //echo "<pre>1234";print_r($frmdata['getdeliverydetail']);die;
		if(isset($frmdata['getdeliverydetail']) and (count($frmdata['getdeliverydetail'])>0)){
				  foreach($frmdata['getdeliverydetail'] as $k=>$delivery){?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4 mb10">
                            <b>Product: </b>
                            <?php echo $delivery->product.((!empty($delivery->name))? " / ".$delivery->name:'');?>
                        ...
                        <?php 
                        if(isset($delivery->notconfirmed) && $delivery->notconfirmed==1){
                           ?>
                    ...
                    <div class="greyborder">
                     <div class="panel-body">
                       <!-- <div class="col-md-4 mb10">
                        ...
                        <div class="col-md-4 mb10">
                            <b>Product: </b>
                            <?php echo $discovery->product.(!empty($discovery->name)?" / ".$discovery->name:'');?>
                        </div>
                        <div class="col-md-4 mb10">
                            <b>Weight: </b>
