<div class="row">
    <div class="col-md-6">
        ...
        <?php echo form_open("admin/order/index", array("id" => "search")); ?> 
...
<!--                                    <th>Contact</th>-->
                            ...
                            <tbody>
                                ...
                                $currentvalue = 1;
                                $thispageavalue = $currentvalue*$curpageno; 
                                foreach ($alldata as $key => $value) { ?>
                                    <tr>
                                        ...
                                        if ($value->orderstatus == '2')
                                            ...
                                            $i = 2;
                                        ?>
                                        <td class="colors<?php echo $i; ?>"><?php echo ++$thispageavalue; ?></td>
                                        ...
                                        <td class="colors<?php echo $i; ?>"><?php echo $value->team; ?></td>            
                                        <td class="colors<?php echo $i; ?>"> <?php
                                            //echo $value->email_Id;
                                            foreach ($value->alllocation as $singleLocation) {
                                                echo $singleLocation['location'];
                                                echo "<br>";
                                            }
                                            ?>
...
<!--                                        <td class="colors<?php echo $i; ?>"><?php echo $value->contact_No; ?></td>-->
        ...
        ?>
                                        ...
                                        <td class="colors<?php echo $i; ?>"> 
                                            <a type="button" class="" value="view_details" title="Complains"  href="<?php echo site_url('admin/order/complains/' . $value->id); ?>">
                                               <i class="glyphicon glyphicon-question-sign" >  <?php /* echo $value->compNo; */ ?> </i> 
											</a>
                                        </td>
                                        <td> 
...
<style>
.contentcenter th {text-align: center;}
</style>
