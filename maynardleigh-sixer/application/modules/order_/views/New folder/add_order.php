<?php
   ...
   //echo "##<pre>";print_r($dttrans['transview']);die; 
     $yesno=array('0'=>'Yes',
                   '1'=>'No');
     $mod_ofpayment=array('Cheque'=>'Cheque',
                           'NEFT'=>'NEFT',
...
<div class="smart-wrap">
   <div class="smart-forms  wrap-1">
      <div class=" smart-steps">
         ...
         <?php echo form_open_multipart("admin/order/add_order"."/".$id); ?>
                     ...
                     <fieldset>
                        <div class="main_boxes" id="p_scents4">
                           <div class="rows">
                              <div class="frm-row">
                                 <div class="section colm colm6">
                                    <h4> <label>Address with Street</label></h4>
                                 ...
                                 <div class="section colm colm6">
                                    ...
                                    <label class="field prepend-icon">
                                       <?php //echo form_dropdown('astate', $salesBy,'', 'class="form-control" id="name_of_state"');?>
                                    </label>
                                 </div>
                                 <!-- end section --> 
                              </div>
                  ...
                  <div class="panel-body">
                     <fieldset>
                        <div class="frm-row">
                           ...
                           <!-- end section -->
                           <div class="section colm colm6">
                              <h4> <label>Cancellation Clause</label></h4>
                              <label class="field prepend-icon">
                                 <!-- <input type="text" name="Last_Name" id="Last_Name" class="gui-input" placeholder="Cancellation clouse"> -->
                                 <?php $data=array('name'=>'tccancellation',
                                    'class'=>'gui-input',
                                    'placeholder'=>'Cancellation Clause',
                                     'value'=>isset($frmdata['orderdata']->cancellation_clouse)?$frmdata['orderdata']->cancellation_clouse:""
                                    
                                    );
                                    echo form_input($data);
                                    ?><?php //echo form_error('tccancellation');?>
                              </label>
                           </div>
                           <!-- end section --> 
                        </div>
                        ...
                        <div class="frm-row">
                           ...
                           <!-- end section -->
                           <div class="section colm colm6">
                              <h4><label>Blanket Contract NoPayment Cycle</label></h4>
                              <label class="field prepend-icon">
                        ...
                        <!-- end frm-row section -->
                        <div class="frm-row">
                           <div class="section hight colm colm12">
                        ...
                        <div class="frm-row">
                           ...
                           <div class="section colm colm6 hight">
                              <h4><label>Payment Cycles</label></h4>
                        ...
                        <div class="frm-row">
                           <div class="section colm colm6 ">
                              <h4><label class="field prepend-icon" name="charges">Service Tax Charges: &nbsp;</label></h4>
                              Yes&nbsp;<input type="radio" name="tax" value="yes"   
                                 <?php echo set_radio('',''); ?> />&nbsp;
                              No&nbsp;<input type="radio" name="tax" value="no"   
                                 <?php echo set_radio('',''); ?> />
                           </div>
                           <!-- <div class="section colm colm6">
  ...
  $(function() {
   $( "#country" ).autocomplete({
      source: function( request, response ) {
        $.ajax({
          url: "<?php echo site_url('admin/order/requestPinCode'); ?>",
          dataType: "json",
          data: {
            q: request.term
          },
      ...
      select: function( event, ui ) {
            ...
            $("#taluka").html(ui.item['divisionname']);
            $("#divison").html(ui.item['divisionname']);
            $("#reg").html(ui.item['egionname']);
            $("#cir").html(ui.item['circlename']);
            $("#state").html(ui.item['circlename']);
