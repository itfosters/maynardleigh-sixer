                        ...
                        <table class="table table-striped table-bordered table-hover" summary="">
                            <thead class="thead-inverse">
                                ...
                                <tr>
                                    ...
                                    <th width="40%">Complain Description</th>
							...
							<tr>
							    ...
							    <td><?php echo $value->orderID; ?></td>
                                                            <td><?php echo isset($value->cmp_title)?$value->cmp_title:''; ?></td> 
...
<tr>
  ...
  <td>
      <select id="counter" name="counter" class="form-control add_responsival" count='1'>
...
var len = 1;
  $('#addScnt').on('click', function() {
    ...
    $('<tr class="input-wrap"><td><select  count="'+i+'"  name="add_'+i+'" class="form-control add_responsival"><option>Select Responsival</option> <option value="CM">Resources</option><option value="O">Others</option> </select></td><td><div class="decide_'+i+'" id="decide_type"></div></td><td><a href="#" class="remScnt"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a></td></tr>').appendTo(scntDiv);
...
switch(data)
{
case 'O':$('.decide_'+count).html('<input type="text" class="form-control">');
break;
case 'CM':$('.decide_'+count).html('<select name="resource" class="form-control">'+'<option>Select Resources</option>'+'</select>');
break;
}
 })
