...
class Workreportclients extends ITF_Model {
...
$this->db->select('O.order_id,AD.start_date,AD.end_date,AD.order_type,AD.diagnose_id,AD.status');
$this->db->from($this->order." as O");
$this->db->join($this->assigndate." as AD","O.client_id=AD.order_id");
$this->db->where('AD.status','1');
$this->db->where('O.client_id',$mid);
