...
<div class="row">
<div class="col-md-6">
    <?php echo form_open("admin/manager", array("id" => "search")); ?>
   ...
   <!--<a type="button" class="btn btn-primary" value="view_details" href="<?php //echo site_url('delivery/insert'.'/'.$ids)?>">Add Delivery</a>-->
   				 <div class="dropdown text-right">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li><a href="<?php echo site_url('admin/manager/form'); ?>"><i class="fa fa-plus-circle"></i> Add</a></li>
                            <li class="divider"></li>
    ...
    <div class="col-md-12">                         
        <div class="table-responsive">
            <?php echo form_open("admin/manager/deleted", array("id" => "frmitf")); ?>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!--<td><a href="<?php echo site_url('manager/insert'); ?>" title="Insert"><i class="fa fa-file-text"></i></a></td>-->
                        <td><a href="<?php echo site_url('admin/manager/form/'.$itfdata->id); ?>" title="Edit"><i class="fa fa-pencil"></i></a> </td>
                         <td><a href="<?php echo site_url('admin/manager/deleted/'.$itfdata->id); ?>" onclick="return confirm('Are you sure?')" title="Delete"><i class="fa fa-trash-o"></i></a></td>
