   ...
   <!--<a type="button" class="btn btn-primary" value="view_details" href="<?php //echo site_url('delivery/insert'.'/'.$ids)?>">Add Delivery</a>-->
                    <div class="dropdown text-right">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li><a href="<?php echo site_url().'admin/subproduct/addChildForm/'.$id; ?>"><i class="fa fa-plus-circle"></i> Add</a></li>
                            <li class="divider"></li>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="<?php echo site_url('admin/subproduct/addChildForm/'.$itfdata->parent_id.'/'.$itfdata->id); ?>" title="Edit"><i class="fa fa-pencil"></i></a></td>
                        <td> <a href="<?php echo site_url('admin/subproduct/index'); ?>" title="Sub Product"><i class="fa fa-map-marker"></i></a></td>
                       
                        <td> <a href="<?php echo site_url('admin/subproduct/deleted/'.$itfdata->parent_id); ?>" onclick="return confirm('Are you sure?')" title="Delete"><i class="fa fa-trash-o"></i></a></td>
                    </tr>
                    <?php  }?>
                </tbody>
            </table>
