...
<table style="width:100%;  border: 1px solid black; border-collapse: collapse;">
  ...
  <tr>
   ...
   <tr>
     <td style=" border: 1px solid black; height: 45px;padding:10px 0px 10px 10px;" valign="top">Delivey</td>
    <td style=" border: 1px solid black;padding:10px 0px 10px 10px;" valign="top">
    	 <table width="100%">
			<?php  
...
<strong>Witness:</strong>________________________________
 ...
 <table align="center" cellpadding="" cellpadding="" width="75%" style="margin:30px auto">
 <tr>
 <td>
		...
		<?php echo form_open("contract_accept/accept/".$frmdata['detail']->id,array("id"=>"accept")); ?>
         <button class="btn btn-primary" onClick="window.print()">Printed and Put in Process</button>
		<?php
		//echo "!!!!!!!!<pre>";print_r($frmdata['detail']->status);die;
		if((isset($frmdata['detail']->status)) && ($frmdata['detail']->status==0)){
		?>
		<input type="submit" value="I am authorized to Accept it" onclick='return confirm("Are you sure to confirm this date ?")' class="btn btn-success mt20" />
		...
		<?php } else { ?>
		<div class="status"><?php echo $frmdata['detail']->status=="1"?"<h3>You have accepted this request.</h3>":"<h3>You have rejected this request.</h3>"?></div>
		<?php }?>
