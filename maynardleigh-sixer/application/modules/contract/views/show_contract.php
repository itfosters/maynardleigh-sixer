<?php
//echo "###<pre>";print_r($frmdata['detail']->nda_required);die;
        ...
        <tr>
            <td align="right" class="hidden-print">
                    <div style="float:right;padding: 5px;">
                        <a class="btn btn-success mt20" target="_blank" href="<?php echo site_url('contract_accept/printContract/'.$frmdata['detail']->id);?>">View As PDF</a>
                    </div>
            </td>
        </tr>
    </table>
    ...
    <tbody>
        <tr>
            <td width="400" align="left" style="margin-top: 15px;">
                ...
                <table>
                    <tr>
                        <Td><strong>By</td><td>:</strong></td><td><strong><img src="<?php echo site_url().ASSESTS_ULR.'admin/img/'. 'steve.png'; ?>"></strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <Td><strong>Witness</td><td>:</strong></td><td><strong><img src="<?php echo site_url().ASSESTS_ULR.'admin/img/'. 'knika.png'; ?>"></strong></td>
                    </tr>
                </table>
                ...
                <td style="padding:20px 0px 15px 0px; margin-top: 25px;">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td height="50" valign="bottom" align="left">
                                    <a target="#" title="Visit Pinterest"><img src="<?php echo site_url().IMG_URL . 'default.jpg'; ?>"></a>
            ...
            <tr>
                ...
                <td width="400" align="left" style="margin-top: 15px;">
                    <table>
                        ...
                        <tr>
                            <td><img src="<?php echo site_url().ASSESTS_ULR.'admin/img/'. 'stamp.png'; ?>" style="margin-right: 392px;" ></td>
                        </tr>
                        <tr>
                            <td></td>
                        </tr>
