...
<div class="col-md-6">
  <div class="form-group">
    ...
    <?php echo form_dropdown('dproducts',$frmdata['product'],isset($frmdata['subdiagnoseid']->products)?$frmdata['subdiagnoseid']->products:"", 'class="form-control" id="name_of_products"');?> 
    <?php echo form_error('dproducts'); ?>
  </div>
</div>
<div class="col-md-6">
  <div class="form-group">
    <label>Sub-Products:</label>
    <?php echo form_dropdown('dsubproducts',$frmdata['subproducts'],isset($frmdata['subdiagnoseid']->subproducts)?$frmdata['subdiagnoseid']->subproducts:"", 'class="form-control" id="name_of_subproducts"');?> 
...
<div class="col-md-6">
  <div class="form-group">
    <label>Start Date<span class="red_text">*</span>
        ...
        &nbsp;Not Confirm<?php
        $flag = isset($frmdata["subdiagnoseid"]->notconfirmed) && $frmdata["subdiagnoseid"]->notconfirmed == 1 ? TRUE : FALSE;
        $data1 = array(
            'name' => 'notconfirmed',
            'id' => 'notconfirmed',
            'value' => '1',
