...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo ucfirst($airinfo->clause) . " " . $airinfo->dept_time; ?><br><strong><?php echo $airinfo->description; ?></strong></td>
</tr>
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo ucfirst($traininfo->clause) . " " . $traininfo->dept_time; ?></strong></td>
</tr>
...
<!--<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;">&nbsp;</td>
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;">&nbsp;</td>
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;">Meals in the Air: <?php echo (isset($allmode['air'][0]->food) and !empty($allmode['air'][0]->food)) ? ucfirst($allmode['air'][0]->food):'N/A'; ?></td>     
</tr>-->
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;">Meals Remarks: <?php echo (isset($allmode[0]->diet_remark) and !empty($allmode[0]->diet_remark)) ? ucfirst($allmode[0]->diet_remark):'N/A'; ?>
