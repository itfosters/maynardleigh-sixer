...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;color: rgb(9,52,86);text-align: center;">Meals Type: <?php echo (isset($allmode['air'][0]->food) and !empty($allmode['air'][0]->food)) ? strtoupper($allmode['air'][0]->food):'N/A'; ?></td>     
</tr>
