...
$producttype = [''=>'Select Type','1'=>'Diagnose','2'=>'Design','3'=>'Delivery','4'=>'Discovery'];
?>
<div class="row">
<div class="col-md-10">
<?php echo form_open("admin/product", array("id" => "search")); ?>
<!--   <div class="input-group form-group" style="margin-left: 3px;">-->
      ...
      <input type="text" name="q" placeholder="Search" class="form-control" value="<?php echo isset($frm_data['q'])?$frm_data['q']:''; ?>">
       ...
       <div class="col-md-3">
        <?php
        $selecteddropdown = isset($frm_data['ptype'])?$frm_data['ptype']:'';
        echo form_dropdown('ptype',$producttype,$selecteddropdown,'class="form-control"'); ?>
       </div>
...
<div class="col-md-2 pull-right"> 
   ...
   <!--<a type="button" class="btn btn-primary" value="view_details" href="<?php //echo site_url('delivery/insert'.'/'.$ids)?>">Add Delivery</a>-->
    <div class="col-md-1 pull-left">
        <a href="<?php echo site_url('admin/product/importProduct'); ?>" title="Product Import / Update by excel "><i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
    </div>             
    <div class="dropdown text-right col-md-1">
...
<?php echo form_open("admin/product/deleted", array("id" => "frmitf")); ?>
  ...
  <?php echo form_input(array('type'=>'hidden','name'=>'pagevalue','value'=>$page));?>         
