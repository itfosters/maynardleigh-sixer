...
<body>
  ...
  <div class="form-group">
    ...
    <?php echo form_dropdown('dsubproducts',$frmdata['subproducts'],isset($frmdata['subdiscoveryid']->subproducts)?$frmdata['subdiscoveryid']->subproducts:"", 'class="form-control" id="name_of_subproducts"');?> 
