    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        foreach ($itfdata['view'] as $value) {
            ...
            <tr>
                ...
                <td> <?php
                                            //echo $value->email_Id;
                                            foreach ($value->date as $singleDate) {
                ...
                <td>
                    ...
                    <!--        <a type="button" class="" value="view_details" title="Get URL" href="<?php echo site_url('welcome/generateurl/' . $value->id); ?>">
                            ...
                            <a type="button" class="" value="view_details"  title="View Order Details" href="<?php echo site_url('welcome/details/'.$value->order_id);?>">
                        ...
                        <a type="button" class="" value="view_details"  title="Submit Leadership Report" 
                           href="<?php echo site_url('order/resouces_form/' . $value->id . "/" . $value->diagnose_id . "/" . $value->order_type); ?>">
                            ...
                            <?php if($value->moreinfo['executive_call_flag']==0){?>
                        <a type="button" class="" value="view_details"  title="Call Now" 
                           href="<?php echo site_url('delivery/user_call/' . $value->order_id . "/" . $value->diagnose_id . "/" . $value->order_type); ?>">
                            <i class="fa fa-phone" aria-hidden="true"></i></a>

                    <?php }else {?>
                            <a type="button" class="" value="view_details"  title="View Participant Details" 
                           href="<?php echo site_url('delivery/getParticipantDetails/' . $value->order_id . "/" . $value->diagnose_id ); ?>">
                            <i class="fa fa-users" aria-hidden="true"></i></a>

                    <?php }} ?>
                        <a type="button" class="" value="view_details" title="Complains"  href="<?php echo site_url('order/complains/' . $value->order_id); ?>">
