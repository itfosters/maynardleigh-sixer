...
//echo "<pre>";print_r($catalystcallflage);die;
?>
<div class="row">
<div class="col-md-6">
...
<!--                              <th>Email</th>-->
                        ...
                        <?php if(in_array('2',$delivery))
                              ...
                              $i=2;
                              ?>
                           <tr <?php echo (isset($searchedid) && ($searchedid==$value->id)) ? 'class="yellowsearch"':''; ?> >
...
<!--                              <td><?php echo $value->email_id;?></td>-->
                            ...
                            ?>
                              ...
                              if(in_array($value->pid,$excutivecallflage)){
                              ?>
                              ...
                              <a type="button" class="" value="view_details" title="Excel import" href="<?php echo site_url('admin/delivery/excelEmport/'.$value->order_id.'/'.$value->id);?>">
                                  ...
                                  <a type="button" class="" value="view_details" title="View Time Slot of Participant" href="<?php echo site_url('admin/delivery/timeslot/'.$value->order_id."/".$value->id);?>">
                              <i class=" fa fa-clock-o" aria-hidden="true"></i></a>
                                </td>
                                  <?php } else if(in_array($value->pid,$catalystcallflage)){?>
                              <td class="colors<?php echo $i; ?>">
                              <a type="button" class="" value="view_details" title="Excel import" href="<?php echo site_url('admin/delivery/excelEmport/'.$value->order_id.'/'.$value->id);?>">
                                  <i class=" fa fa-file-excel-o"></i></a>&nbsp;
                              <a type="button" class="" value="view_details" title="View Time Slot of Resource" href="<?php echo site_url('admin/delivery/timeslot/'.$value->order_id."/".$value->id);?>">
                              <i class=" fa fa-clock-o" aria-hidden="true"></i></a>
                               
                               </td>
                              <?php } ?>
                              <td class="colors<?php echo $i; ?>"> 
                              <a type="button" class="" value="view_details" title="Edit" href="<?php echo site_url('admin/delivery/form/'.$value->order_id.'/'.$value->id."/".$page);?>">
...
<!--                             <td class="colors<?php echo $i; ?>"> 
                             ...
                             <td class="colors<?php echo $i; ?>"> 
                              <a type="button" class="travel-pop" value="view_details" title="Close Order" href="<?php echo site_url('admin/delivery/archievePopUp/'.$value->order_id.'/'.$value->id);?>">
