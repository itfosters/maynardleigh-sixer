...
<div class="popup_boxes trail_periods_block">
    ...
    <div class="col-md-8 col-md-offset-2" style="background-color: #fff; padding-top: 40px;">
        ...
        <form action="<?php echo site_url('admin/delivery/archievePopUp'); ?>" method="post" accept-charset="utf-8" id="" name="" class="form-bordered ">  
            ...
            <input type="hidden" name="type_id" value="<?php echo isset($frm_data['type_id']) ? $frm_data['type_id'] : '3'; ?>">
            <div class="col-md-12 form-group" >

                <h1 class="page-head-line"> Add Invoice no for Archive: </h1>
                <div class="trf-droup" >

                    <div class="col-sm-4 from">
                    <div class="form-group">
                    <label><b> Invoice Number </b> </label>
                    <input required="required" type="text" class="form-control" name="invoice_no" value="<?php echo isset($frm_data['resourceInfos']->journey_from)?$frm_data['resourceInfos']->journey_from:''; ?>" >
                    </div>
                    </div>
