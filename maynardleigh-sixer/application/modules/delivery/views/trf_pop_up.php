...
<div class="popup_boxes trail_periods_block">
  ...
  <div class="col-md-8 col-md-offset-2" style="background-color: #fff; padding-top: 40px;">
    ...
    <form action="<?php echo site_url('admin/delivery/saveTrfInfos');?>" method="post" accept-charset="utf-8" id="" name="" class="form-bordered ">  
    ...
    <input type="hidden" name="ids" value="<?php echo (isset($frm_data['resourceInfos']->id)) && (!(isset($frm_data['selected']))) ?$frm_data['resourceInfos']->id:''; ?>">
    
    <?php if(isset($frm_data['olddata'][0])){?>
    <div class="col-md-12 form-group" >
        <h4>Existing TRF List (select for edit)</h4>
    </div>
    <div class="col-md-12 form-group" >
        <table class="table">
        <?php foreach($frm_data['olddata'] as $existingTRF){
            ?>
          <tr>      
              <th scope="col"><?php echo ucfirst($existingTRF->mode);?></th>
            <th scope="col"><?php echo $existingTRF->journey_date;?></th>
            <th scope="col"><?php echo $existingTRF->journey_from;?></th>
            <th scope="col"><?php echo $existingTRF->journey_destination;?></th>
            <th scope="col" colspan="2">
             <a class="fa fa-pencil-square-o travel-pop btnwd" href="<?php echo site_url('admin/delivery/trfPopUp/'.$existingTRF->order_id.'/'.$existingTRF->diagnose_id.'/'.$frm_data["user_id"].'/'.$existingTRF->id."/selected"); ?>"></a>
            </th> 
          </tr>
          ...
          <div  class="col-sm-3">
            <div class="form-group">
             ...
             <select name="mode" class="form-control" id="type">
              ...
              <option value="Venue" <?php if(isset($frm_data['resourceInfos']->mode) and $frm_data['resourceInfos']->mode == 'Venue'){echo 'selected="selected"';} ?>> Venue </option>
            </select>
          </div>
        </div>
    ...
    <div class="travel" >
     ...
     <div class="col-sm-4 add_hotel">
      <div class="form-group "> 
        ...
        <?php 
          $category=array(''=>'Select Category','1 Star'=>'1 Star','2 Star'=>'2 Star','3 Star'=>'3 Star','4 Star'=>'4 Star','5 Star'=>'5 Star');
       ...
       <div class="col-sm-4 cabe" >
          <div class="form-group"> 
           <label><b>Room Preference</b> </label>
              ...
              <?php 
          $category=array(''=>'Select Room Preference','Smoking'=>'Smoking','Non Smoking'=>'Non Smoking');
...
<div  class="col-sm-4 lease" style="visibility:hidden">
          <div class="form-group">
  ...
  <div  class="col-sm-4" id="desc">
    <div class="form-group"> 
     ...
     <textarea class="form-control custom-control" rows="4" cols="10" name="description"><?php echo isset($frm_data['resourceInfos']->description)?$frm_data['resourceInfos']->description:''; ?> </textarea>
        ...
        <div id="returnclause" class="returnclause">   
   <div class="col-sm-4 clause">
      <div class="form-group"> 
        <label> <b>Return Clause</b> </label>
        <select name="return_claus" class="form-control">
          <option value="0"> Select Clause </option>
          <option value="after" <?php if(isset($frm_data['resourceInfos']->return_claus) and $frm_data['resourceInfos']->return_claus == 'after'){echo 'selected="selected"';} ?>>After</option>
          <option value="before" <?php if(isset($frm_data['resourceInfos']->return_claus) and $frm_data['resourceInfos']->return_claus == 'before'){echo 'selected="selected"';} ?>> Before </option>
        </select>
      </div>
    </div>
         <div class="col-sm-4 time">
      <div class="form-group"> 
       <label><b>Return Time </b> </label>
       <input type="text"  class="form-control" name="return_time" id="basicExample1" value="<?php echo isset($frm_data['resourceInfos']->return_time)?$frm_data['resourceInfos']->return_time:''; ?>" />
     </div>
   </div>
     </div>
        <div id="venueclause" class="venueclause">
            <div  class="col-sm-4" id="desc">
                <div class="form-group"> 
                    <label><b>Venue Detail</b> </label>
                    <textarea class="form-control custom-control" rows="4" cols="10" name="venuedetail"><?php echo isset($frm_data['resourceInfos']->venuedetail) ? $frm_data['resourceInfos']->venuedetail : ''; ?> </textarea>
                </div>
            </div>
        </div>
