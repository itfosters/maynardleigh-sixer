...
<div class="row">
<div class="col-md-6">
<?php echo form_open("admin/client", array("id" => "search")); ?>
...
<!--<a type="button" class="btn btn-primary" value="view_details" href="<?php //echo site_url('delivery/insert'.'/'.$ids)?>">Add Delivery</a>-->
        ...
        <ul class="dropdown-menu" aria-labelledby="dLabel">
            <li><a href="<?php echo site_url('admin/client/form'); ?>"><i class="fa fa-plus-circle"></i> Add</a></li>
            <li class="divider"></li>
...
<?php echo form_open("admin/client/deleted", array("id" => "frmitf")); ?>
...
<tbody>
    ...
    <tr>
        ...
        <td><?php echo $itfdata->street; ?></td>
        <td><?php echo $itfdata->location; ?></td>
        <td><?php echo $itfdata->city; ?></td>
        <td><?php echo $itfdata->state; ?></td>
        <td><?php echo $itfdata->pincode; ?></td>
        <td><?php echo $itfdata->contact_no; ?></td>
        <td><a type="button" href="<?php echo site_url('admin/client/form/'.$itfdata->id); ?>" title="Update"><i class="fa fa-pencil"></i></a></td>
        <td><a type="button" href="<?php echo site_url('admin/client/deleted/'.$itfdata->id); ?>" title="Delete" onclick="return confirm('Are you sure?')" ><i class="fa fa-trash-o"></i></a></td>
    </tr>
    <?php  } ?>
</tbody>
