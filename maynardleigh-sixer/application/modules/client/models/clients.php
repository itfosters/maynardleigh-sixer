...
class Clients extends ITF_Model {
    ...
    protected $billing_address = "client_addressbilling";
    ...
    //public function multiple billing address
    public function addBillingAddress($data=array()) {
        $this->db->insert_batch($this->billing_address, $data);    
    }
    //public function delete billing address
    public function deleteBillingAddress($client_id) {
        $data = array('client_id'=>$client_id);
        $this->db->where($data);
        $this->db->delete($this->billing_address);   
    }
    //public function get billing address
    public function getBillingAddress($client_id) {
        $data = array('client_id'=>$client_id);
        $this->db->from($this->billing_address);
        $this->db->where($data);
        $query = $this->db->get()->result();  
        return $query;
    }
