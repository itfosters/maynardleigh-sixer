            ...
            <div  class="col-sm-3">
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <?php echo form_dropdown('dnocasting[]',$frmdata['castingmanager'],'','class=" form-control" id="no_of_casting"');?> 
                  </div>
