...
<div class="row">
    ...
    <div class="col-md-6 text-right"> 
        <a href="<?php echo site_url('admin/order/add_complain/' . $ordId); ?>" target="" value="Add New" class="btn btn-primary" type="button">Add VOC</a>
    </div>
</div>
<div class="row">
                        ...
                        <table class="table table-striped table-bordered table-hover" summary="">
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <td <?php echo isset($value['data']->status)&& $value['data']->status==1 ? 'style="text-decoration: line-through;"':''; ?>>
                                            <!-- related to -->
                                        ...
                                        <td>
                                            <a title="Edit" href="<?php echo site_url('admin/order/add_complain/' . $ordId . '/' . $value['data']->cmp_id); ?>"><i class="fa fa-pencil"></i> </a>
                                            &nbsp;<a title="Delete" onclick="deleteComplain('<?php echo $value['data']->cmp_id; ?>', '<?php echo $ordId; ?>')"><i class="fa fa fa-trash-o"></i></a>
                                            &nbsp;<a title="Close VOC" onclick="completeComplain('<?php echo $value['data']->cmp_id; ?>', '<?php echo $ordId; ?>')"><i class="fa fa-check-square-o" aria-hidden="true"></i></a>
                                        </td>    
...
<script type="text/javascript">
    ...
    function completeComplain(comId, ordId) {
        if (confirm("Are you sure for VOC close ?")) {
            window.location.href = ADMINURL + 'order/complete_complains/' + comId + '/' + ordId + '.html';
        }
    }
