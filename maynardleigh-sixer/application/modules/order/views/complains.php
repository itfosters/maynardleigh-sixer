                            ...
                            <tbody>
                                <?php foreach ($alldata as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo isset($value['data']->order_Id)?$value['data']->order_Id:'0'; ?></td>
                                        <td><?php echo isset($value['data']->cmp_type) ? $complainstype[$value['data']->cmp_type] : ''; ?></td> 
                                        <td><?php echo html_entity_decode($value['data']->cmp_desc);  //echo $value->cmp_desc;  ?></td>
                                        <td>
                                            <!-- related to -->
