                           ...
                           <tr>
                             ...
                             <?php }else if($value->lunchflage==1){?>
                              ...
                              <?php  }elseif(!(isset($frmdata['selectedtimeslot']))){ ?>
                                  ...
                                  <a onclick="return confirm ('Are you so sure for book this time slot for you ?')" href="<?php echo site_url('usercall_accept/accept/'.$frmdata['oid']."/".$value->id."/".$frmdata['user_id']."/".$frmdata['did']); ?>" class="btn btn-primary mb10">Book This One!</a>
