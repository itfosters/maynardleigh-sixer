...
//echo "<pre>";print_r($selectedProductForDiagnose);die;
    ...
    <table style="background-color:#ffffff; margin:0 auto;" width="75%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="right" class="hidden-print">
                <!--            <button class="btn btn-primary" onClick="window.print()">Print</button>-->
<?php
//echo "<pre>qwww";print_r($frmdata);die;
if ((isset($frmdata['detail']->status)) && ($frmdata['detail']->status == 0)) {
    ?>
                    ...
                    <?php echo form_open("contract_accept/accept/" . $frmdata['detail']->id, array("id" => "accept")); ?>
                        <input onClick="return first_print();" type="button" value="Print"  class="btn btn-success mt20" />
...
<?php } ?>
                <div class="collapse" id="collapseExample">
                    <div class="well mt10">
                <?php echo form_open("contract_accept/reject"); ?>
                    ...
                    <table  border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2" align="center" ><strong><p style="font-size: 16px; margin: 0; text-decoration: underline;">Contract For 
                                            "<?php
    $totalpax = 0;
    $totaldays = 0;
    $totalunits = 0;
...
<!--                                <td align="left" width="200px" valign="bottom"></td>-->
                                ...
                                <td width = '20%' align="right" valign="bottom"  >
                                    <a target="#" title="Maynardleigh Online">
                                        <img style="margin-bottom: 40px; height: 130px;" src="http://sixer.maynardleighonline.in/assests/img/may.png">
                                    </a>
...
<!--<p>1. No of days - <?php echo $totalunits; ?> days</p>-->
                    <table style="width:100%;  border: 1px solid black; border-collapse: collapse;" id="print_for_pdf">
                        <tr>
...
//                    	}
    ...
    ?>
                            ...
                            <?php } ?>
                        <tr>
                            <td colspan="6" style=" border: 1px solid black; height: 45px;">Total Cost</td>
                            <td style="height: 45px; text-align:right; padding:10px;">
                        <?php
        ...
        <tbody>
            <tr>
                <td width="400" align="left" style="margin-top: 15px;">
                    ...
                    <table>
                        <tr>
                            <Td>By</td><td>:</td><td><strong><strong><img src="<?php echo site_url().ASSESTS_ULR.'admin/img/'. 'steve.png'; ?>"></strong></strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <Td>Witness</td><td>:</td><td><strong><strong><img src="<?php echo site_url().ASSESTS_ULR.'admin/img/'. 'knika.png'; ?>"></strong></strong></td>
                        </tr>
                    </table>
                </td>
               <td width="400" align="left" style="margin-top: 15px;">
                    <table>
                        ...
                        <tr>
                            <td><img src="<?php echo site_url().ASSESTS_ULR.'admin/img/'. 'stamp.png'; ?>" style="margin-right: 413px;" ></td>
                        </tr>
                        <tr>
                            <td></td>
                        </tr>
...
<?php if (isset($frmdata['detail']) && ($frmdata['detail']->nda_required) == 'Yes') { ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="right" width="400px" valign="bottom" >
                                        <a target="#" title="Maynardleigh Online"><img style="margin-bottom: 40px; height: 130px;" src="http://sixer.maynardleighonline.in/assests/img/may.png" /></a>
            ...
            <tbody>
                <tr>
                    <td align="left" valign="bottom" width="100%">
                        <strong><p style="font-size: 16px; margin: 0;">Non-Disclosure agreement:</p></strong>


                        <p style="margin: 0;"> WHEREAS, Client is willing to receive information from the service provider regarding the program, which information the Service Provider deems proprietary.</p>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <td width='20%'   style="padding: 10px; position: relative;">
...
<script>
    function first_print() {
        ...
        //window.print();
        $.ajax({
            url: FRONTURL + 'contract_accept/sendnotification',
            dataType: 'json',
            type: 'post',
            data: {
                order_id: '<?php echo $frmdata['detail']->id; ?>',
                client_name: '<?php echo $frmdata['detail']->client_name; ?>',
                client_location: '<?php echo $frmdata['detail']->alocation . ", " . $frmdata['detail']->city . ", " . $frmdata['detail']->state; ?>',
            },
            beforeSend: function() {
