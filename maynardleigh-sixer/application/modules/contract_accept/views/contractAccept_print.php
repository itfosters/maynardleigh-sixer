...
<td  align="center" style="margin: 20px; padding: 20px;"><strong><p style="font-size: 16px; margin: 0; text-decoration: underline;">Contract For 
			"<?php $totalpax=0;
					 $totaldays=0;
                                          $totalunits = 0;
				foreach($frmdata['diagonoesdetail'] as $key =>$diagnose) 
						{ //echo $diagnose->product .' ( '. $diagnose->name; echo ')'; 
							$totalpax += $diagnose->pax;
							$totaldays += $diagnose->no_ofdays;
                                                        $totalunits += $diagnose->units;
						} 
			?> 
			<?php foreach($frmdata['getdesigndetail'] as $key =>$design) 
						{ //echo $design->product .' ( '. $design->name; echo ')'; 
							$totalpax += $design->pax;
							$totaldays += $design->no_ofdays;
                                                        $totalunits += $design->units;
						} 
			?> 
			<?php  foreach($frmdata['getdeliverydetail'] as $key =>$delivery) 
						{ //echo $delivery->product .' ( '. $delivery->name; echo ')'; 
							$totalpax += $delivery->pax;
							$totaldays += $delivery->no_ofdays;
                                                        $totalunits += $delivery->units;
						} 
			?> 
			<?php  foreach($frmdata['getdiscoveryDetail'] as $key =>$discovery) 
						{ //echo $discovery->product .' ( '. $discovery->name; echo ')'; 
...
<a target="#" title="Maynardleigh Online">
<img style="margin-bottom: 40px; height: 160px;" src="http://sixer.maynardleighonline.in/assests/img/may.png">
</a>
...
<table width="75%" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto">
<tbody>
<tr>
<td valign="bottom" align="left">
<!--<p>This Contract, effective as of <span style="background-color:yellow;"><?php echo date('jS F, Y',strtotime($frmdata['detail']->entry_Time)); ?></span> is by and between Life Strategies Humancare Private Limited, a Private Limited Company, Incorporated under the Companies act 1956 having a place of business at 26 A, Chelmsford Country Club, Club Drive, Mehrauli Gurgaon Road, Ghitorni, New Delhi - 110030 <?php echo $frmdata['detail']->client_name; ?> having a place of business at <?php echo $frmdata['detail']->street ?>&nbsp;<?php echo $frmdata['detail']->location ?>&nbsp;<?php echo $frmdata['detail']->pincode  ?>
 </p>-->
    ...
    <td style=" border: 1px solid black; padding:10px 0px 10px 10px; text-align: center;" >
        <table width="100%">
			...
			{?>
                <tr>
                    <td>
                    	<?php $start= date('d-m-Y',strtotime($diagnose->start_date)); $end=date('d-m-Y',strtotime($diagnose->end_date));
			...
			<?php  
                ...
                <tr>
                    <td>
                         ...
                         <?php echo moneyFormatIndia($diagnose->price_unit);?>  
                    </td>
                </tr>
             <?php 
			}
    ...
    ?>
			...
			<?php  
				...
				{$sumofdiagnose=$diagnose->price_unit*$diagnose->units;
						...
						}  //echo moneyFormatIndia($sumoftotal);
			}
			?>
    ...
    <td style=" border: 1px solid black; padding:10px 0px 10px 10px;  text-align: center;">
		<table width="100%">
			...
			foreach($frmdata['getdesigndetail'] as $key =>$design) {?>
                <tr>
                    <td>
                    	<?php $start= date('d-m-Y',strtotime($design->start_date)); $end=date('d-m-Y',strtotime($design->end_date));
    ...
    <td style=" border: 1px solid black;   text-align: center;">
		<table width="100%">
			...
			foreach($frmdata['getdeliverydetail'] as $key =>$delivey) {?>
                <tr>
                    <td><?php $start= date('d-m-Y',strtotime($delivey->start_date)); $end=date('d-m-Y',strtotime($delivey->end_date));
                    	if($start==$end){
		...
		<table width="100%">
			<?php 
			 ...
			 foreach($frmdata['getdiscoveryDetail'] as $key =>$discovery) {?>
                <tr>
                    <td>
                    	<?php $start= date('d-m-Y',strtotime($discovery->start_date)); $end=date('d-m-Y',strtotime($discovery->end_date));
...
<strong><p style="font-size: 16px; margin: 10px;">Incidental Costs:</p></strong>
...
<?php $transportvalue=array('n'=>'N/A','c'=>'Client','m'=>'MLA');
...
<table>
                    <tr>
                        <td><b>By</b></td><td>:</td><td> <strong>&nbsp;Steeve Gupta</strong></td>
                    </tr>
                    <tr>
                        <td><b>Name</b></td><td>:</td><td><strong> &nbsp;Steeve Gupta</strong></td>
                    </tr>
                    <tr>
                        <td><b>Title</b></td><td>:</td><td><strong> &nbsp;Director</strong></td>
                    </tr>
                    <tr>
                        <td><b>Witness</b></td><td>:</td><td><strong>__________________________</strong></td>
                    </tr>
                </table>
</td>
<td width="400" align="left" style="margin-top: 15px;">
...
<table>
                    <tr>
                        <td><strong>By</strong></td><td>:</td><td><strong> __________________________</strong></td>
                    </tr>
                    <tr>
                        <td><strong>Name</strong></td><td>:</td><td><strong> __________________________</strong></td>
                    </tr>
                    <tr>
                        <td><strong>Title</strong></td><td>:</td><td><strong> __________________________</strong></td>
                    </tr>
                    <tr>
                        <td><strong>Witness</strong></td><td>:</td><td><strong>__________________________</strong></td>
                    </tr>
                </table>
</td>
</tr>
...
<td align="center" style="padding: 10px; position: relative;">
...
<table>
                    <tr>
                        <td><strong>By</strong></td><td>:</td><td><strong> &nbsp;Steeve Gupta</strong></td>
                    </tr>
                    <tr>
                        <td><strong>Name</strong></td><td>:</td><td><strong> &nbsp;Steeve Gupta</strong></td>
                    </tr>
                    <tr>
                        <td><strong>Title</strong></td><td>:</td><td><strong> &nbsp;Director</strong></td>
                    </tr>
                    <tr>
                        <td><strong>Witness</strong></td><td>:</td><td><strong>__________________________</strong></td>
                    </tr>
...
<p style="font-size: 16px; text-decoration: underline; margin: 0; position: absolute;bottom: 0; font-weight: bold">Accounting Details</p>
...
<table cellspacing="0"  cellpadding="0" border="0" width="75%" style="margin:0 auto">
    <tr>
        <td align="left"><u>Please fill in below</u> </td>
    </tr>
    <tr>
        <td align="left">Invoice to be sent to the attention of </td>
    </tr>
    <tr>
        <td align="left">__________________________________________ </td>
    </tr>
    ...
    <tr>
        <td align="left">Accounts Fax:  </td>
    </tr>
    <tr>
        <td align="left">__________________________________________ </td>
    </tr>
    <tr>
        <td align="left">E-mail to Accounts Payable : </td>
    </tr>
    <tr>
        <td align="left">__________________________________________ </td>
    </tr>
    <tr>
        <td align="left">Payment Cycle Details: (If any): </td>
    </tr>
    <tr>
        <td align="left">__________________________________________ </td>
    </tr>
