...
<div class="col-md-6">
  <div class="form-group">
    ...
    <?php echo form_dropdown('dgproducts',$frmdata['product'],isset($frmdata['subdesignid']->products)?$frmdata['subdesignid']->products:"", 'class="form-control" id="name_of_products"');?> 
  <?php echo form_error('dgproducts'); ?>
  </div>
</div>
<div class="col-md-6">
  <div class="form-group">
    <label>Sub-Products:</label>
    <?php echo form_dropdown('dsubproducts',$frmdata['subproducts'],isset($frmdata['subdesignid']->subproducts)?$frmdata['subdesignid']->subproducts:"", 'class="form-control" id="name_of_subproducts"');?> 
