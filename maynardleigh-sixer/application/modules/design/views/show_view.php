...
<div class="col-md-6">
  <div class="form-group">
    ...
    <?php $data=array('name'=>'dgdetails',
'class'=>'gui-input  form-control',
'placeholder'=>'Details',
'value'=>isset($frmdata["subdesignid"]->details)?$frmdata["subdesignid"]->details:''
);
echo form_input($data);

?><?php echo form_error('dgdetails');?>
  </div>
</div>
<div class="col-md-6">
  <div class="form-group">
...
<div class="col-md-6">
  <div class="form-group">
    <label>Units</label>
    <?php echo form_dropdown('dgunits', $priceunit,isset($frmdata['subdesignid']->units)?$frmdata['subdesignid']->units:"", 'class="form-control" id="no_of_units"');?> </div>
</div>
...
<div class="col-md-6">
  <div class="form-group">
    ...
    <?php echo form_dropdown('dgnoofdays', $noofcasting,isset($frmdata['subdesignid']->no_ofdays)?$frmdata['subdesignid']->no_ofdays:"", 'class="form-control" id="no_of_days"');?> </div>
</div>
<div class="col-md-6">
  <div class="form-group">
