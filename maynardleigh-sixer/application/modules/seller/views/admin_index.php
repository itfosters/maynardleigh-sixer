...
<div class="row">
<div class="col-md-6">
<?php echo form_open("admin/seller", array("id" => "search")); ?>
   ...
   <!--<a type="button" class="btn btn-primary" value="view_details" href="<?php //echo site_url('delivery/insert'.'/'.$ids)?>">Add Delivery</a>-->
                     <div class="dropdown text-right">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li><a href="<?php echo site_url('admin/seller/form'); ?>"><i class="fa fa-plus-circle"></i> Add</a></li>
                            <li class="divider"></li>
...
<?php echo form_open("admin/seller/deleted", array("id" => "frmitf")); ?>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a title="Edit" href="<?php echo site_url('admin/seller/form/'.$itfdata->id); ?>"><i class="fa  fa-pencil "></i></a></td>
                        <td> <a href="<?php echo site_url('admin/seller/deleted/'.$itfdata->id); ?>" onclick="return confirm('Are you sure?')" title="Delete"><i class="fa fa fa-trash-o"></i></a>
                        </td>
                  </tr>
                    <?php  } ?>
                </tbody>
