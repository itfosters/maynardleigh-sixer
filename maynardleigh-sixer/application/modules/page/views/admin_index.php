<div class="row mb10">
    <div class="col-sm-10">
        <?php echo form_open("admin/page",array("id"=>"frmserach")); ?>
    ...
    <div class="col-md-2">
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a  href="<?php echo site_url("admin/page/form"); ?>">Add pages</a></li>
                <li class="divider"></li>
...
<div class="row">
    <div class="col-md-12">							
        <div class="table-responsive">    
            ...
            <?php echo form_open("admin/page/delete",array("id"=>"frmitf"),array("itfids"=>"","itfaction"=>"")); ?>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="<?php echo site_url("admin/page/form/".$itfdata->id ); ?>" data-toggle="tooltip" title="Edit" class="tooltips"><i class="fa fa-pencil"></i></a>
                    </td>
                </tr>
                <?php  } ?>
            </tbody>
