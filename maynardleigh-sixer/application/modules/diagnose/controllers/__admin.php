...
//        echo "<pre>12345".$strtotime;print_r($data['time_detail']);echo "<hr>";
  //      echo "<pre>12345".date('H:i A',$strtotime);print_r($data['time_detail']);die;
        ...
        $this->template->set_breadcrumb("DELIVERY LISTING", site_url("admin/diagnose/index/" . $oid));
        $this->template->set_breadcrumb("TRAVEL REQUEST FORM", site_url("admin/diagnose/trf/" . $oid . "/" . $digid . "/" . $user_id));
