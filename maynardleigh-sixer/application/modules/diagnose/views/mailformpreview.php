...
?>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-4">
            ...
            <div id="file_browse_wrapper1">
             <input type="file" id="participant_list" name='participant_list'>
            </div>
        </div>
        <div class="form-group col-md-5"><input type="button" name="browseclear" value="Clear" class="clear"></div>
    </div>
    <div class="col-md-12">
        <div class="form-group col-md-3">
            <label>VMS:</label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-6">
            ...
            foreach ($allmode['cab'] as $cabinfo) {
                 $cabvalue.= date('jS F,Y', strtotime($cabinfo->journey_date)) . " ".($cabinfo->journey_from)."-".($cabinfo->journey_destination)." (".$cabinfo->description.")"."<br>";
            }
            ...
            </div><span><input type="button" name="cabclear" value="Clear" class="clear"></span>
        </div>
        <div class="form-group col-md-3"></div>
    </div>
    <?php } ?>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-6">
            <?php
            $data = array('name' => 'notes_by_admin',
                'class' => 'gui-input form-control',
                'placeholder' => 'Notes',
                'id' => 'notes_by_admin',
                'rows'=> '5',
...
if($('#cab').length)
    CKEDITOR.replace('cab', config);
if($('#train').length)
CKEDITOR.replace('train', config);
if($('#air').length)
CKEDITOR.replace('air', config);
CKEDITOR.replace('notes_by_admin', config);
</script>