...
<html lang="en-IN">
    ...
    <body>
        <table class="maintable" width="75%" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                    <td class="tdmain">
...
<!--                                    <td valign="bottom" align="left">
                                    ...
                                    <td  colspan="4" align="center" class="innertd"><p class="pclass"><b>Contract For 
                                                "<?php
                                                $totalpax = 0;
                                                $totaldays = 0;
                                                $totalunits = 0;
...
<!--                                    <td align="right" valign="bottom" >
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="marginzero">
            <tbody>
                <tr>
                    <td valign="bottom" align="left">
                        ...
                        <p class="tdspan"><b>Scope of the Contract:</b></p>


                        <table class="pdfprint" id="print_for_pdf">
                            <tr>
                                <td class="ttotal"></td>
                            ...
                            if (isset($frmdata['get_diagnose']) and ( count($frmdata['get_diagnose']) > 0)) {
                                ...
                                <tr>
                                    ...
                                    <td class="pprice" valign="top">Diagnose</td>
                            ...
                            if (count($frmdata['getdesigndetail']) > 0) {
                                ?>
                                <tr>
                                    <td class="pprice" valign="top">Design</td>
                                    <td class="pprice1">
                                        <table width="100%">
                                            <?php
                                            $counter = 1;
                            ...
                            if (count($frmdata['getdeliverydetail']) > 0) {
                                ...
                                <tr>
                                    <td class="pprice" valign="top">Delivery</td>
                                    <td class="pprice1">
                                        <table width="100%">
                                            <?php
                                            $counter = 1;
                            ...
                            if (count($frmdata['getdiscoveryDetail']) > 0) {
                                ?>
                                <tr>
                                    <td class="pprice" valign="top">Discovery</td>
                                    <td class="pprice1">
                                        <table width="100%">
                                            <?php
                                            $counter = 1;
...
//                    	}
                            ...
                            <?php } ?>
                            <tr>
                                <td class="ttotal">Total Cost</td>
                                <td colspan="6"  class="costinner">
                                    <?php
                ...
                <tr>
                    <td align="left">
                        <p class="incidentalcost"><b>Incidental Costs:</b></p>
                        <ul>
                        ...
                        <p class="paymentterms"><b>Payment Terms</b></p>
                        <ol>
...
//echo "<pre>";print_r($cancellationClouseArray[$frmdata['detail']->cancellation_clouse]);die;
                        ...
                        <p class="pclassp"><b>Other arrangements that Client will take care of:</b></p>
                        <ul>
                        ...
                        <p class="paymentterms"><b>A Non-Disclosure Agreement for the scope of this contract is included as an annexure</b></p><br>
            ...
            <tbody>
                <tr>
                    <td width="400" align="left" class="lifestrategies">
                        <p class="detail"><b>Life Strategies Humancare Pvt Ltd.</b>
                        </p>

                        <table>
                            <tr>
                                <Td><b>By</b></td><td>:</td><td><b> &nbsp;Steeve Gupta</b></td>
                            </tr>
                            <tr>
                                <Td><b>Name</b></td><td>:</td><td><b> &nbsp;Steeve Gupta</b></td>
                            </tr>
                            <tr>
                                <Td><b>Title</b></td><td>:</td><td><b> &nbsp;Director</b></td>
                            </tr>
                            <tr>
                                <Td><b>Witness</b></td><td>:</td><td><b>__________________________</b></td>
                            </tr>
                        </table>
                    </td>
                    <td width="400" align="left" class="lifestrategies">
                        <p class="detail"><b><?php echo $frmdata['detail']->client_name ?></b></p>

                        <table>
                            <tr>
                                <Td><b>By</b></td><td>:</td><td><b> __________________________</b></td>
                            </tr>
                            <tr>
                                <Td><b>Name</b></td><td>:</td><td><b> __________________________</b></td>
                            </tr>
                            <tr>
                                <Td><b>Title</b></td><td>:</td><td><b> __________________________</b></td>
                            </tr>
                            <tr>
                                <Td><b>Witness</b></td><td>:</td><td><b>__________________________</b></td>
                            </tr>
        ...
        <?php if (isset($frmdata['detail']) && ($frmdata['detail']->nda_required) == 0) { ?>
            ...
            <table class="nda_required" width="75%" border="0" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td class="inner_nda">
                        </td>
                ...
                <tbody>
                    <tr>
                        <td align="left" valign="bottom" width="100%">
                            ...
                            <p class="nondisclosure"> <b>WHEREAS, Client is willing to receive information from the service provider regarding the program, which information the Service Provider deems proprietary.</b></p>
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="75%" class="margineauto">
            <tbody>
                <tr>
                    <td align="left" valign="bottom" width="100%">
                        <p><b>Life Strategies Humancare Pvt. Ltd.</b></p>
...
<style>
    ...
    .pclass{font-size: 16px; margin: 0;  text-decoration: underline;}
    ...
    .ttotal{border: 1px solid black; height: 45px;}
    .tableborder{border: 1px solid black;}
    .costinner{border: 1px solid black;height: 45px; text-align:right; padding:10px;}
    .incidentalcost{font-size: 16px; margin: 10px;}
    ...
    .moreinfo{list-style: nomber; margin-top: 12px;}
