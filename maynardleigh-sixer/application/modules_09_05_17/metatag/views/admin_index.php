<div class="row mb10">
	<div class="col-sm-10">
		<?php echo form_open("admin/metatag",array("id"=>"frmserach")); ?>
	...
	<div class="col-md-2">
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				<li><a  href="<?php echo site_url("admin/metatag/form"); ?>">Add Meta</a></li>
				<li class="divider"></li>
...
<div class="row">
	<div class="col-md-12">							
		<div class="table-responsive">
			<?php echo form_open("admin/metatag/delete",array("id"=>"frmitf"),array("itfids"=>"","itfaction"=>"")); ?>
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						<td class="event_row"><?php echo form_checkbox(array('class'=>'itfrowdatas','name'=>'itfrowdata[]', 'value'=>$itfdata->id)); ?></td>
						<td><?php echo $itfdata->name; ?></td>
						<td><?php echo $itfdata->entry_date; ?></td>             
						...
						<td><a href="<?php echo site_url("admin/metatag/form/".$itfdata->id ); ?>" data-toggle="tooltip" title="Edit" class="tooltips"><i class="fa fa-pencil"></i></a></td>
					</tr>
					<?php  } ?>
				</tbody>
			</table>
