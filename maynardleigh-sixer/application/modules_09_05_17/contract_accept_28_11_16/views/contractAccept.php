...
$cancellationClouseArray[1]=array(
                        '50% of the professional fee â€“ 15 to 3 working days of the confirmed date of delivery.',
                        '100% of professional fee â€“ 2 to 0 working days of the confirmed date of delivery.'
                        );
$cancellationClouseArray[2]=array(
                        '50% of the professional fee â€“ 20 to 3 working days of the confirmed date of delivery.',
                        '100% of professional fee â€“ 2 to 0 working days of the confirmed date of delivery.'
                        );
$cancellationClouseArray[3]=array(
                                '50% of the professional fee â€“ 24 to 4 hrs of the confirmed date and time of call.',
                                '100% of professional fee â€“ 4 to 0 hrs of the confirmed date and time of call.'
                                );
...
<!--<p>This Contract, effective as of <span style="background-color:yellow;"><?php echo date('jS F, Y',strtotime($frmdata['detail']->entry_Time)); ?></span> is by and between Life Strategies Humancare Private Limited, a Private Limited Company, Incorporated under the Companies act 1956 having a place of business at 26 A, Chelmsford Country Club, Club Drive, Mehrauli Gurgaon Road, Ghitorni, New Delhi - 110030 <?php echo $frmdata['detail']->client_name; ?> having a place of business at <?php echo $frmdata['detail']->street ?>&nbsp;<?php echo $frmdata['detail']->location ?>&nbsp;<?php echo $frmdata['detail']->pincode  ?>
    ...
    <p>This Contract, effective as of <span style="background-color:yellow;"><?php echo date('jS F, Y',strtotime($frmdata['detail']->entry_Time)); ?></span> is by and between Life Strategies Humancare Private Limited, a Private Limited Company, Incorporated under the Companies act 1956 having a place of business at 26A, Chelmsford Country Club, Mehrauli Gurgaon Road, Ghitorni, New Delhi - 110030(hereinafter "Service Provider"), and <?php echo $frmdata['detail']->client_name; ?> , having a place of business at <?php echo $frmdata['detail']->street ?>&nbsp;<?php echo $frmdata['detail']->state ?>&nbsp;<?php echo $frmdata['detail']->city ?>&nbsp;<?php echo $frmdata['detail']->alocation ?>&nbsp;<?php echo $frmdata['detail']->pincode  ?> (Hereinafter "Client").
    ...
    <td style=" border: 1px solid black;  text-align: center;">
    	<table width="100%">
			...
			{?>
                <tr>
                    <td>
                    	<?php $sumtotaldesign=$design->price_unit*$design->units;
   ...
   <tr>
    ...
    <table width="100%">
			...
			{?>
                <tr>
                    <td>
                    	<?php $sumtotaldelivey=$delivey->price_unit*$delivey->units;
   ...
   <tr>
    ...
    <table width="100%">
			...
			{?>
                <tr>
                    <td>
                    	<?php $sumtotaldiscovery=$discovery->price_unit*$discovery->units;
