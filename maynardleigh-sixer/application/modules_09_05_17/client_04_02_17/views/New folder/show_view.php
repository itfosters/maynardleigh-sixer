...
<!--<a type="button" class="btn btn-primary" value="view_details" href="<?php //echo site_url('delivery/insert'.'/'.$ids)?>">Add Delivery</a>-->
        ...
        <ul class="dropdown-menu" aria-labelledby="dLabel">
            <li><a href="<?php echo site_url('admin/client/insert'); ?>"><i class="fa fa-plus-circle"></i> Add</a></li>
            <li class="divider"></li>
...
<tbody>
    ...
    <tr>
        ...
        <td><?php echo $itfdata->address; ?></td>
        <td><?php echo $itfdata->contact_no; ?></td>
        <td><a type="button" href="<?php echo site_url('admin/client/insert/'.$itfdata->id); ?>" title="Update"><i class="fa fa-pencil"></i></a></td>
