...
<div class="col-md-2 pull-right"> 
                    ...
                    <ul>
                    <li><a type="button" value="view_details" title="Assing User" class="travel-pop" href="<?php echo site_url('admin/delivery/assignUser/'.$frmdata['oid'].'/'.$frmdata['delvid']);?>">
                    <i class="fa fa-user"></i></a></li></ul>
        ...
        <div class="table-responsive">
                ...
                <?php foreach ($frmdata['showuserdata'] as $key => $value) {?>
                    <tr>
                        ...
                        <td><a href="<?php echo site_url('admin/user_manager/form/'.$value->id); ?>" title="Edit"><i class="fa fa-pencil"></i></a> </td>
                         <td><a href="<?php echo site_url('admin/user_manager/deleted/'.$value->id); ?>" onclick="return confirm('Are you sure?')" title="Delete"><i class="fa fa-trash-o"></i></a></td>
