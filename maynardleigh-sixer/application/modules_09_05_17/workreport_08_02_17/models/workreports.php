...
$this->db->select('AD.id,AD.order_id,AD.order_type,AD.diagnose_id,AD.start_date,AD.start_time,AD.end_date,AD.end_time,AD.comment,AD.del_comment,U.name as clientname,AD.status,UC.name AS clientsname');
