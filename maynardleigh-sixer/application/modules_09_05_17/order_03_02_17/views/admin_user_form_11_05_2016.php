                        ...
                        <div class="main_boxes" id="p_scents4">
                           <div class="rows">
                              ...
                              <div class="section colm colm12">
                                    ...
                                    <input type="checkbox" id="checkbox" name="checkbox" class="clientval" value="">
               ...
               <div aria-expanded="false" id="collapse6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                  <div class="panel-body">
                     <fieldset>
                        ...
                        <div class="frm-row">
                           <div class="section colm colm6 ">
                              <h4><label class="field prepend-icon" name="charges">Tax Charges: &nbsp;</label></h4>
                              Yes&nbsp;<input type="radio" name="tax" value="yes" checked="checked">   
                                 <?php echo set_radio('',''); ?>&nbsp;
                           ...
                           <!-- <div class="section colm colm6">
                             ...
                             <div class="section colm colm6 hight">
                              <?php if(empty($id)){?>
                              <h4><label>Term & Conditions:</label></h4>
                            <?php }else{?>
                            <h4><label>Term & Conditions Payment Terms:</label></h4>
                     ...
                     <fieldset>
                        ...
                        <div class="section colm colm6 ">
                              ...
                              Yes&nbsp;<input type="radio" name="tax" value="yes">   
                                 <?php echo set_radio('',''); ?>&nbsp;
                              No&nbsp;<input type="radio" name="tax" value="no" checked="checked"   
                                 <?php echo set_radio('',''); ?> />
                        </div>
                        <!-- end section --> 
                        <!-- end frm-row section -->
