<div class="row mb10">
	<div class="col-sm-10">
		<?php echo form_open("admin/block",array("id"=>"frmserach")); ?>
	...
	<div class="col-md-2">
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				<li><a  href="<?php echo site_url("admin/block/form"); ?>">Add Block</a></li>
				<li class="divider"></li>
...
<div class="col-md-12">							
	<div class="table-responsive">
		...
		<?php echo form_open("admin/block/delete",array("id"=>"frmitf"),array("itfids"=>"","itfaction"=>"")); ?>
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="<?php echo site_url("admin/block/form/".$itfdata->id ); ?>" data-toggle="tooltip" title="Edit" class="tooltips"><i class="fa fa-pencil"></i></a></td>
			</tr>
			<?php  } ?>
		</tbody>
	</table>
