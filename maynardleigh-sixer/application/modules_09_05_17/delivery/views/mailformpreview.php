...
?>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-6">
            ...
            $data = array('name' => 'course',
                ...
                'value' => isset($frm_data["order_detail"]->proname) ? $frm_data["order_detail"]->proname." / ".$frm_data["order_detail"]->subproductname : "",
                'id' => 'course'
            );
            echo form_input($data);
            ?>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-6">
            ...
            ?>
            <div id="file_browse_wrapper1">
            Attach Ticket <input type="file" id="air_ticket" name='air_ticket'>
            </div>
        </div>
        <div class="form-group col-md-3"></div>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-6">
            ...
            <div id="file_browse_wrapper1">
            Attach Ticket <input type="file" id="train_ticket" name='train_ticket'>
            </div>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-6">
            ...
            foreach ($allmode['cab'] as $cabinfo) {
                 $cabvalue.= date('jS F', strtotime($cabinfo->journey_date)) . " ".strtoupper($cabinfo->journey_from)."-".strtoupper($cabinfo->journey_destination)." (".$cabinfo->description.")"."<br>";
            }
