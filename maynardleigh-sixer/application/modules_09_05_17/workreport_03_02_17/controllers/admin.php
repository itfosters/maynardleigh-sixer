...
class Admin extends ITFS_Controller {
   ...
   public function index()
	...
	public function showAllDates()
	{
        ...
        //echo "<pre>";print_r($data['view']);die;
	...
	function downloadExcel()
	{
		...
		//echo "<pre>";print_r($where);die;
		$headings =  array('Resource','Product','Weightage','Subproducts','Client Name','Location','Start Date','End Date','Start time','End time','Status','Comment');
		//$users=$this->workreports->getAssignDateDownload($where);
		//$users=$this->workreports->getAssignDateDownload($where);
