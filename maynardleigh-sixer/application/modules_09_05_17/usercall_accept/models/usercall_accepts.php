...
class Usercall_accepts extends ITF_Model {
   ...
   //protected $name = "order";
    ...
    private $timeslot="itf_time_slot_master";
    ...
    public function get_timdslot($where=array())
    {
        $this->db->select('TS.resource_id,TS.start_time_slot,TS.end_time_slot');
        $this->db->from($this->usermap.' as UM');
        $this->db->join($this->timeslot.' as TS','TS.delivery_id=UM.delivery_id');
        $this->db->where($where);
