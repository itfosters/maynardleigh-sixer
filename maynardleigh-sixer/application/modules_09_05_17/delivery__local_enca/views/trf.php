    ...
    <div class="row">
        ...
        <table class="table">
          ...
          <tr>      
            ...
            <th scope="col"><a id="vendermails" title="Send To Resource" href="<?php echo site_url('admin/discovery/mailVenderRequestForm/'.$frmdata['odered_id'].'/'.$frmdata['diagnose_id']); ?>"><i class="fa fa-envelope-o btn"></i></a></th> 
            <th scope="col"><a download ="" id="downloads" target="_blank"  title="Print File" href="<?php echo site_url('admin/discovery/downloadTRForm/'.$frmdata['odered_id'].'/'.$frmdata['diagnose_id']); ?>"><i class="fa fa-print btn"></i></a></th> 
          </tr>
      </thead>
