<div class="popup_boxes trail_periods_block">
  <div class="col-md-6 col-md-offset-3" style="background-color: #fff; padding-top: 40px;">
    <?php echo form_open('admin/delivery/setusers'); 
            ...
            <div  class="col-sm-3">
              <div class="form-group">
                <div class="col-md-12">
                  <div class="form-group"> 
                  <label>Users</label>
                  <?php echo form_dropdown('dnocasting[]',$frmdata['assignuser'],isset($frmdata['selectedmangers'])?$frmdata['selectedmangers']:array(), ' multiple="multiple" class="selectpicker form-control" id="no_of_casting"');?> 
                  </div>
                  <div class="form-group">
