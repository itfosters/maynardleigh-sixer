...
<img src="<?php echo IMG_URL.'logo.gif'; ?>" />
</a>
...
"<?php echo $frmdata['detail']->first_name ?>&nbsp;<?php echo $frmdata['detail']->last_name ?>"</p>
	...
	'<?php echo $frmdata['detail']->seller_name ?>'</p>
	<p style="font-size: 16px; margin: 0;  text-decoration: underline;">Contract No - CO/LSHPL/<?php echo date('Y');?>/2803331(Auto generate </p></strong>
	</td>
...
<p>This Contract, effective as of 28th of March 2016(date of order - OE) is by and between Life Strategies Humancare Private Limited, a Private Limited Company, Incorporated under the Companies act 1956 having a place of business at 26 A, Chelmsford Country Club, Club Drive, Mehrauli Gurgaon Road, Ghitorni, New Delhi - 110030 (hereinafter <strong>“Service Provider”),</strong> and <?php echo $frmdata['detail']->first_name ?>&nbsp;<?php echo $frmdata['detail']->last_name ?>  (name of the client&ndash; OE), having a place of business at <?php echo $frmdata['detail']->street ?>&nbsp;<?php echo $frmdata['detail']->location ?>&nbsp<?php echo $frmdata['detail']->pincode  ?>
			...
			<?php  
                ...
                <tr>
                    <td>
                         ...
                         <?php echo $counter.'. '.$diagnose->units;?>  
                    </td>
                </tr>
             <?php 
			$counter++;
			...
			<?php  
                ...
                <tr>
                    <td>
                         ...
                         <?php echo $counter.'. '.$diagnose->price_unit;?>  
                    </td>
                </tr>
             <?php 
			$counter++;
     ...
     <td style=" border: 1px solid black;  text-align: center;">
	 	<table width="100%">
			<?php  
                ...
                <tr>
                    <td>
                    	<?php echo $counter.'. '.$delivey->units;?>
                    </td>
                </tr>
             <?php 
			$counter++;
     ...
     <td style=" border: 1px solid black;  text-align: center;">
	 	<table width="100%">
			...
			foreach($frmdata['getdeliverydetail'] as $key =>$delivey) {?>
                <tr>
                    <td>
                    	<?php echo $counter.'. '.$delivey->price_unit;?>
                    </td>
                </tr>
            <?php 
			$counter++;
	 	...
	 	<table width="100%">
			<?php  
			 ...
			 foreach($frmdata['getdiscoveryDetail'] as $key =>$discovery) {?>
                <tr>
                    <td>
                    	<?php echo $counter.'. '.$discovery->units;?>
                    </td>
                </tr>
            <?php 
			$counter++;
	 	...
	 	<table width="100%">
			<?php  
			 ...
			 foreach($frmdata['getdiscoveryDetail'] as $key =>$discovery) {?>
                <tr>
                    <td>
                    	<?php echo $counter.'. '.$discovery->price_unit;?>
                    </td>
                </tr>
             <?php 
			$counter++;
...
<li>In case of cancellation/rescheduling fees will be charged as follows –</li>
...
<tr>
<td height="50" valign="bottom" align="left">
<a target="#" title="Visit Pinterest"><img src="<?php echo IMG_URL.'logo.gif'; ?>"></a>
