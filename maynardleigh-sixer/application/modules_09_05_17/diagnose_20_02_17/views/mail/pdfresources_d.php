...
<table style="border-collapse: collapse; width: 100%;border: 1px solid #000;font-family: Helvetica;"> <tr>
  ...
  <tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px; height: 50px;font-size: 14px;">Workshop/Prework Details </td> 
    <td style="border: 1px solid #000; padding: 5px; height: 50px;font-size: 14px;">Communicating with Presence</td>
  </tr>
  
  <tr style="border: 1px solid #000; padding: 5px">
    <td style="border: 1px solid #000; padding: 5px; height: 50px;font-size: 14px;">Venue Detail</td>
    <td style="border: 1px solid #000; padding: 5px;font-size: 14px;" colspan="2"><?php echo isset($allmode['Venue'][0]->venuedetail) ? $allmode['Venue'][0]->venuedetail : 'N/A'; ?></td>
    <td style="border: 1px solid #000; padding: 5px; height: 50px;font-size: 14px;">Order ID.</td>
    <td style="border: 1px solid #000; padding: 5px; height: 50px;font-size: 14px;"><?php echo $order_detail->order_Id; ?></td>
  </tr>
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo empty($airinfo->description)? strtoupper($airinfo->clause) . " " . $airinfo->dept_time:''; ?><br><strong><?php echo $airinfo->description; ?></strong></td>
</tr>
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo strtoupper($airinfo->journey_destination); ?></td>
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo strtoupper($airinfo->journey_from); ?></td> 
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo empty($airinfo->description)? strtoupper($airinfo->return_claus) . " " . $airinfo->return_time:''; ?><br><strong><?php echo $airinfo->description; ?></strong></td> 
</tr>
<?php }
}
?>
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo empty($traininfo->description)? strtoupper($traininfo->clause) . " " . $traininfo->dept_time:''; ?><br><strong><?php echo $traininfo->description; ?></strong></td>
</tr>
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo strtoupper($traininfo->journey_destination); ?></td>
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo strtoupper($traininfo->journey_from); ?></td> 
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px"><?php echo empty($traininfo->description) ? strtoupper($traininfo->return_claus) . " " . $traininfo->return_time:''; ?><br><strong><?php echo $traininfo->description; ?></strong></td> 
</tr>
<?php }
}
}
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;"><?php echo empty($cabinfo->description) ? strtoupper($cabinfo->dept_time):""; ?><br><strong><?php echo $cabinfo->description; ?></strong></td>     
</tr>
               <?php 
               $i++;
    } ?>
...
<tr style="border: 1px solid #000; padding: 5px">
    <td style="border: 1px solid #000; padding: 5px; height: 50px;font-size: 14px;" colspan="2">Contact Details:N/A</td>
...
<tr style="border: 1px solid #000; padding: 5px">
    <td style="border: 1px solid #000; padding: 5px; height: 50px;font-size: 14px;"><strong>Hotel Name (<?php echo $allmode['Hotel'][0]->city; ?>)</strong></td>
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;"><strong>Check IN Date</strong></td>
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;"><strong>Hotel Check OUT Date  (<?php echo $allmode['Hotel'][0]->city; ?>)</strong></td>
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;"><strong><?php echo $allmode['Hotel'][0]->description; ?></strong><br></td> 
</tr>
 <?php } ?>
