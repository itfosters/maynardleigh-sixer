...
<div class="row">
   <div class="col-md-12">
    ...
    <thead class="thead-inverse">
     <th>ID</th>
     <th>JOURNEY DATE</th><TH>RETURN DATE</TH><TH>CITY</TH><TH>PREFERRED AIRLINES</TH><TH>JOURNEY FROM</TH><TH>JOURNEY DESTINATION</TH><TH>CLAUSE</TH><TH>DEPT TIME</TH><TH>DESCRIPTIONS</TH>
       </thead>
        <tbody>
          <tr>
          ...
          <td><?php echo $record['preferred']; ?></td>
