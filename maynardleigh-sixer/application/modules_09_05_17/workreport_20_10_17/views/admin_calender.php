     ...
     $('.sdate').text("Please Select Start Date");
       ...
       $.ajax({
                ...
                success: function (emp_list) {
                    ...
                    $(".table").empty();
                    var headertext = "<tr><th>Name</th><th>Job</th><th>Weightage</th><th>Subproducts</th><th>Location</th><th>Start Date</th><th>Start time</th><th>End Date</th><th>End time</th><th>Status</th></tr>";
                    ...
                    else if (item.status=='1')
                    {
                 	 ...
                 	 if(item.status='2'){
                        ...
                        status='Rejected';
                        txt = "<tr><td>"+clientname+"</td><td>"+pname+"</td><td>"+weight+"</td><td>"+spname+"</td><td>"+location+"</td>"+
