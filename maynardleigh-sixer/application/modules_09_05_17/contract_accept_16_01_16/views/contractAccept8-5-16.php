...
<p>This Contract, effective as of <?php echo $frmdata['detail']->entry_Time; ?>(date of order - OE) is by and between Life Strategies Humancare Private Limited, a Private Limited Company, Incorporated under the Companies act 1956 having a place of business at 26 A, Chelmsford Country Club, Club Drive, Mehrauli Gurgaon Road, Ghitorni, New Delhi - 110030 (hereinafter <strong>“Service Provider”),</strong> and <?php echo $frmdata['detail']->first_name ?>&nbsp;<?php echo $frmdata['detail']->last_name ?>  (name of the client&ndash;; OE), having a place of business at <?php echo $frmdata['detail']->street ?>&nbsp;<?php echo $frmdata['detail']->location ?>&nbsp;<?php echo $frmdata['detail']->pincode  ?>
...
<strong>Witness:</strong>________________________________
 ...
 <a href="<?php echo site_url('contract_accept/accept/'.$frmdata['detail']->id);?>" class="btn btn-primary" >Accept</a>  
 <a href="<?php echo site_url('contract_accept/reject/'.$frmdata['detail']->id);?>" class="btn btn-primary" >Reject</a>  
