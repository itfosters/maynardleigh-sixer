    ...
    public function index($id) 
    {
        ...
        // End of Filter Data
            ...
            $data['link']=$this->pagination->create_links();
			 ...
			 $this->template->set_breadcrumb("ADD DELIVERY",site_url("admin/delivery/form/".$id));
            ...
            $this->form_validation->set_error_delimiters('<div class="error">', '</div>');
                ...
                else 
                {
                    if(empty($subproduct))
                    {
                        ...
                        //echo "<pre>22222@@@@@@@@@@@";print_r($delivered);die;
...
//echo "<pre>";print_r($results);die;
   ...
   function mailTravelRequestFormNew($oid="",$digid="", $user_id="")
    {
        //die('zczdc');
        //echo $user_id;die;
         $this->template->set_layout("ajax");
    ...
    function excelEmport()
    {
        $data['headingtitle']="Front user Listing ";
         //$this->template->set_breadcrumb("ADD DELIVERY",site_url(''));
    $this->template->set_breadcrumb("user Listing","");
        $this->template->build('admin_index _excel_import',$data);
    }
       function trfAllDetails($oid='',$did='',$uid='',$id='')
          {
           ...
           // echo "<pre>";print_r($where);die;
                $data['record']=(array)$this->deliveries->trfAllRecords($where);
                 $this->template->set_breadcrumb("TRAVEL REQUEST FORM",site_url("admin/delivery/trf/".$where['oid'].'/'.$where['did']));
