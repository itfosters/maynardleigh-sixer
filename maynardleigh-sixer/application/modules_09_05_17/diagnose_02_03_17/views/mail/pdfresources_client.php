...
<tr style="border: 1px solid #000; padding: 5px">
    <td style="border: 1px solid #000; padding: 5px; height: 50px;font-size: 14px;" colspan="2">Email:<?php echo isset($userDetails[0]->email) ? $userDetails[0]->email : ''; ?></td>
...
<tr style="border: 1px solid #000; padding: 5px">
    ...
    <td style="border: 1px solid #000; padding: 5px;height: 50px;font-size: 14px;"><strong>Special Arrangement : </strong>Single occupancy, Minimum 4 star. Please include the breakfast & dinner in the package during the hotel confirmation</td>     
</tr>
