<div class="row mb10">
    ...
    <div class="col-sm-10">
        ...
        <?php echo form_open("admin/user",array("id"=>"frmserach")); ?>
    ...
    <div class="col-md-2">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a  href="<?php echo site_url("admin/user/form"); ?>">Add User</a></li>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo site_url("admin/user/form/".$itfdata->id ); ?>" data-toggle="tooltip" title="Edit" class="tooltips"><i class="fa fa-pencil"></i></a></td>
