...
class User extends ITFS_Front_Controller {
...
//echo "<pre>2345";print_r($this->input->post());die;
...
//echo "<pre>1111##########";print_r($this->input->post());die;
        ...
        if ($this->input->post()) {
            ...
            if ($this->auth->login()) {
                ...
                $gotourl = (isset($urlname) and !empty($urlname)) ? $urlname : array("user_manager");
    ...
    public function resource_login() {

//echo "<pre>!!!!!!!!!!1111";print_r($this->input->post());die;
        $this->auth->username='email';

        $this->auth->scope = array("user_type" => "CM","status" => "1");
