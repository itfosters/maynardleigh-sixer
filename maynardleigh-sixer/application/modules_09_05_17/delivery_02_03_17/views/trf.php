...
<!--                <a target="_blank" id="vendermails" title="Send To Resource" href="<?php echo site_url('admin/delivery/mailVenderRequestForm/'.$frmdata['odered_id'].'/'.$frmdata['diagnose_id']); ?>"><i class="fa fa-envelope-o btn"></i></a> -->
                <a target="_blank" id="vendermailspreview" title="Send To Resource" href="<?php echo site_url('admin/delivery/newvendermailslinkspreview/'.$frmdata['odered_id'].'/'.$frmdata['diagnose_id']); ?>"><i class="fa fa-envelope-o btn"></i></a></th> 
            <th scope="col"></th> 
          </tr>
      </thead>
