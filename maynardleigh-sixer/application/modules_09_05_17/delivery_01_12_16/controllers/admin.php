      ...
      //die('dfsdsfsd');
         ...
         $this->load->library('upload');
          ...
          if($_FILES['tmpdocuments'])
...

                {
                    ...
                    foreach ($allDataInSheet as $key => $value) {
...

                        {
                            ...
                            $failedemail=$this->users->isUserExist($email);
                       ...
                       //die('done'); //echo "$$$@@@@<pre>";print_r($success);
                     ...
                     $usermapdata=array();
                        ...
                        $usermapdata['user_id']=$lastinsertedId;
            ...
            $data['showuserdata']=$this->users->showAllUsersForCalling();
