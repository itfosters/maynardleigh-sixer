        ...
        <div  class="col-sm-4">
         ...
         <div  class="col-sm-4 lease" style="display: none;">
          <div class="form-group">
            ...
            <input type="text"  class="datepicker form-control " name="journey_date" id="eddate" value="<?php echo isset($frm_data['resourceInfos']->journey_date)?$frm_data['resourceInfos']->journey_date:''; ?>">
          </div>
        </div>
        <div  class="col-sm-4">
          <div class="form-group">
            <label><b>City</b> </label>
            <input type="text"  class=" form-control " name="journey_date" value="">
          </div>
        </div>
...
<div class="hotel_detail" id="detail">
        ...
        <div  class="col-sm-3">
          <div class="form-group">
            ...
            <input type="text"  class="datepicker form-control" name="journey_date" value="<?php echo isset($frm_data['resourceInfos']->journey_date)?$frm_data['resourceInfos']->journey_date:''; ?>">
          </div>
        </div>
