    ...
    <div class="row">
        ...
        <table class="table">
          ...
          <tr>      
            ...
            <th scope="col">
                <a  class='travel-pop' title='Send To Client' href='<?php echo site_url('admin/delivery/mailTravelRequestFormNewClient/'.$frmdata['odered_id'].'/'.$frmdata['diagnose_id']); ?>'><i class='fa fa-envelope btn '></i></a>
                <a id="vendermails" title="Send To Resource" href="<?php echo site_url('admin/delivery/mailVenderRequestForm/'.$frmdata['odered_id'].'/'.$frmdata['diagnose_id']); ?>"><i class="fa fa-envelope-o btn"></i></a></th> 
            <th scope="col"></th> 
          </tr>
      </thead>
