<div class="row mb10">
	<div class="col-sm-10">
		<?php echo form_open("admin/category",array("id"=>"frmserach")); ?>
    ...
    <div class="col-md-2">
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a  href="<?php echo site_url("admin/category/form"); ?>">Add Category</a></li>
                <li class="divider"></li>
...
<div class="row">
	<div class="col-md-12">							
		<div class="table-responsive">
			...
			<?php echo form_open("admin/category/delete",array("id"=>"frmitf"),array("itfids"=>"","itfaction"=>"")); ?>
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="<?php echo site_url("admin/category/form/".$itfdata->id ); ?>" data-toggle="tooltip" title="Edit" class="tooltips"><i class="fa fa-pencil"></i></a></td>
